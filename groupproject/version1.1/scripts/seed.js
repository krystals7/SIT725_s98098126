...
const haircutData = [
  {
    ...
    price: 110.25,
    duration: '60 min',
    description: 'Professional haircut service in Bondi Beach.'
  },
  {
    id: 'h2',
    salonType: 'Barber',
    ...
    price: 65.95,
    duration: '45 min',
    description: 'Barber haircut and shave service.'
  },
  {
    id: 'h3',
    salonType: 'Hairdresser',
    ...
    price: 159.75,
    duration: '90 min',
    description: 'Haircut and colouring service.'
  },
  {
    id: 'h4',
    salonType: 'Barber',
    ...
    price: 49.50,
    duration: '30 min',
    description: 'Affordable barber haircut service.'
  },
  {
    id: 'h5',
    salonType: 'Hairdresser',
    ...
    price: 139.45,
    duration: '90 min',
    description: 'Haircut and dye service near Bondi Beach.'
  }
];
...
const seedDB = async () => {
  try {
    ...
    console.log('Database seeded successfully with haircut services');
    process.exit();
  } catch (error) {
